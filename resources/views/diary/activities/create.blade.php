        ...
        <div class="container col-lg-6 mt-4">
            <div class="card">
                <div class="card-header d-flex">
                    <ul class="nav nav-tabs card-header-tabs ml-auto float-right" id="formsModes">
                        <li class="nav-item">
                            <a class="nav-link active" href="#lesson" data-toggle="tab">Lesson</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#ther-groups" data-toggle="tab">Ther. Groups</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#sport" data-toggle="tab">Sport</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#walk" data-toggle="tab">Walk</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                    <div class="tab-content">
                            ...
                            <form action="{{ route('activities.store') }}" method="POST">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="lesson_utility" name="utility" max="10" min="0">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="lesson_satisfaction">{{__('activities.satisfaction')}}:</label>
                                        <input type="number" class="form-control" id="lesson_satisfaction" name="satisfaction" max="10" min="0">
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane" id="ther-groups">
                            <h5>Register Therapeutic Groups</h5>
                            <form action="{{ route('activities.store') }}" method="POST">
                                @csrf
                                <div class="form-group">
