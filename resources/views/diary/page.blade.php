    ...
    <div class="container">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="4">{{ __('diary.no_interventions') }}</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="ml-auto">
                    <a href="{{ route('home', $morning_shift) }}" class="btn"><i class='bx bxs-plane-alt'></i>
                        <span class="modify-button">{{ __('crud.add') }}</span></a>
                    <button class="btn-down ml-auto float-right" data-toggle="collapse"
                        data-target="#collapse-outings" aria-expanded="true"
                        aria-controls="collapse-outings">
                        <i class='bx bxs-down-arrow collapse-icon'></i>
                    </button>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-bordered">
                        <thead class="thead-dark">
                            <tr>
                                <th>{{ __('patients.singular') }}</th>
                                <th>{{ __('diary.outing_or_arrive') }}</th>
                            </tr>
                        </thead>
                        @endif
                        @forelse ($outings as $outing)
                        <td>{{ $outings->patient->number ?? '' }} {{ $outing->patient->name }}</td>
                        <td>{{ \Carbon\Carbon::$outing->exit_date->format('d-m-Y')}} {{  \Carbon\Carbon::$outing->return_date->format('d-m-Y')}}</td>
                        @empty
                        @endforelse
                        @if (!empty($outings))
                    </table>
