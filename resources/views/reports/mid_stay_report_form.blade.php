...
@section('content')
    <div class="container-fluid pt-3">
        ...
        <div class="action-buttons">
            <a href="{{ route('patients.edit', $midStayReport->report->patient) }}" class="goBackBtn btn"><i
                    class='bx bx-left-arrow-alt'></i></a>
        </div>
        <h1 class="text-center mb-3">{{ __('reports.mid_stay_report') }}</h1>
                                ...
                                <form action="{{ route('mid_stay_reports.update', $midStayReport) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="request_number" name="request_number"
                                            value="{{ old('request_number', $midStayReport->report->request_number) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nip" name="nip"
                                            value="{{ old('discharge_fundamentals', $midStayReport->nip) }}">
                                        @error('nip')
                                            <span class="span-error" role="alert">
                                                <span>{{ __('form.' . $message) }}</span>
                                            </span>
                        ...
                        <div class="card-body">
                            @if (Auth::user()->speciality === 'admin' || Auth::user()->speciality === 'worker')
                                <form action="{{ route('mid_stay_reports.update', $midStayReport) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="social_familiar_situation" name="social_familiar_situation">{{ old('social_familiar_situation', $midStayReport->report->social_familiar_situation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="professional_situation" name="laboral_educative_economical_situation">{{ old('laboral_educative_economical_situation', $midStayReport->report->laboral_educative_economical_situation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="jury_situation" name="judicial_situation">{{ old('judicial_situation', $midStayReport->report->judicial_situation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="evo_and_objectives" name="social_evo_and_objectives">{{ old('social_evo_and_objectives', $midStayReport->report->social_evo_and_objectives) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="social_diagnosis" name="social_diagnosis">{{ old('social_diagnosis', $midStayReport->report->social_diagnosis) }}</textarea>
                            ...
                            @else
                                <div>
                                    ...
                                    <p>{{ $midStayReport->report->social_diagnosis ?: __('reports.no_available_data') }}
                                    </p>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="card-body">
                            @if (Auth::user()->speciality === 'admin' || Auth::user()->speciality === 'medical')
                                <form action="{{ route('mid_stay_reports.update', $midStayReport) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="toxic_summary" name="about_toxicology">{{ old('about_toxicology', $midStayReport->report->about_toxicology) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="health_situation_at_entry" name="health_at_entry">{{ old('health_at_entry', $midStayReport->report->health_at_entry) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="phisical_health_evo" name="physical_health_condition">{{ old('physical_health_condition', $midStayReport->report->physical_health_condition) }}</textarea>
                                        @error('health_at_entry')
                                            <span class="span-error" role="alert">
                                                <span>{{ __('form.' . $message) }}</span>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="toxic_control_and_analysis" name="toxicological_controls">{{ old('toxicological_controls', $midStayReport->report->toxicological_controls) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="diagnosis_third_axis" name="health_diagnosis">{{ old('health_diagnosis', $midStayReport->report->health_diagnosis) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="health_objectives" name="health_objectives">{{ old('health_objectives', $midStayReport->health_objectives) }}</textarea>
                            ...
                            @else
                                <div>
                                    ...
                                    <p>{{ $midStayReport->report->about_toxicology ?: __('reports.no_available_data') }}
                                    </p>
                                    ...
                                    <label class="label-title"
                                        for="diagnosis_third_axis">{{ __('reports.diagnosis_third_axis') }}:</label>
                                    <p>{{ $midStayReport->report->health_diagnosis ?: __('reports.no_available_data') }}
                                    </p>

                                    <label class="label-title"
                                        for="stated_objectives">{{ __('reports.health_objectives') }}:</label>
                        ...
                        <div class="card-body">
                            @if (Auth::user()->speciality === 'admin' || Auth::user()->speciality === 'psychologist')
                                <form action="{{ route('mid_stay_reports.update', $midStayReport) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="start_valoration" name="psycho_entry_valoration">{{ old('psycho_entry_valoration', $midStayReport->report->psycho_entry_valoration) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="psycho_valoration" name="psycho_evaluation_with_instruments">{{ old('psycho_evaluation_with_instruments', $midStayReport->report->psycho_evaluation_with_instruments) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="diagnosis_first_and_second_axis" name="psycho_diagnosis">{{ old('psycho_diagnosis', $midStayReport->report->psycho_diagnosis) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="psycho_intervention_objectives" name="psycho_interventions">{{ old('psycho_interventions', $midStayReport->report->psycho_interventions) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="motivation" name="about_motivation">{{ old('about_motivation', $midStayReport->report->about_motivation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="psycho_objectives" name="psycho_objectives">{{ old('psycho_objectives', $midStayReport->psycho_objectives) }}</textarea>
                            ...
                            @else
                                <div>
                                    ...
                                    <p>{{ $midStayReport->report->psycho_evaluation_with_instruments ?: __('reports.no_available_data') }}
                                    </p>
                                    <label class="label-title"
                                        for="diagnosis_first_and_second_axis">{{ __('reports.diagnosis_first_and_second_axis') }}:</label>
                                    <p>{{ $midStayReport->report->psycho_diagnosis ?: __('reports.no_available_data') }}
                                    </p>
                                    <label class="label-title"
                                        for="psycho_intervention_objectives">{{ __('reports.psycho_intervention_objectives') }}:</label>
                                    ...
                                    <p>{{ $midStayReport->report->about_motivation ?: __('reports.no_available_data') }}
                                    </p>
                                    <label class="label-title"
                                    ...
                                    <label class="label-title"
                                        for="psycho_objectives">{{ __('reports.stated_objectives') }}:</label>
                        ...
                        <div class="card-body">
                            @if (Auth::user()->speciality === 'admin' || Auth::user()->speciality === 'educator')
                                <form action="{{ route('mid_stay_reports.update', $midStayReport) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="at_habits" name="habit_adaptation">{{ old('habit_adaptation', $midStayReport->report->habit_adaptation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="at_activities" name="activities_adaptation">{{ old('activities_adaptation', $midStayReport->report->activities_adaptation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="at_regulations" name="normativity_adaptation">{{ old('normativity_adaptation', $midStayReport->report->normativity_adaptation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="at_workouts_or_formation" name="workout_adaptation">{{ old('workout_adaptation', $midStayReport->report->workout_adaptation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="at_leisure_and_free_time" name="leisure_adaptation">{{ old('leisure_adaptation', $midStayReport->report->leisure_adaptation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="mates_relation" name="partners_relationship">{{ old('partners_relationship', $midStayReport->report->partners_relationship) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="employees_relation" name="therapeutic_crew_relationship">{{ old('therapeutic_crew_relationship', $midStayReport->report->therapeutic_crew_relationship) }}</textarea>
                            ...
                            @else
                                <div>
                                    ...
                                    <p>{{ $midStayReport->report->habit_adaptation ?: __('reports.no_available_data') }}
                                    </p>
                                    ...
                                    <p>{{ $midStayReport->report->therapeutic_crew_relationship ?: __('reports.no_available_data') }}
                                    </p>
                                </div>
                            @endif
                        </div>
                    ...
                    <div id="collapse-familiar-area" class="collapse hide">
                        <div class="card-body">
                            @if (Auth::user()->speciality === 'admin' || Auth::user()->speciality === 'worker')
                                <form action="{{ route('mid_stay_reports.update', $midStayReport) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="reference_familiars_and_impication_degree" name="reference_familiars">{{ old('reference_familiars', $midStayReport->report->reference_familiars) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="familiar_relation_and_evo" name="familiar_evo_and_realtionship">{{ old('familiar_evo_and_realtionship', $midStayReport->report->familiar_evo_and_realtionship) }}</textarea>
                            ...
                            @else
                                ...
                                <label class="label-title"
                                    for="familiar_relation_and_evo">{{ __('reports.familiar_relation_and_evo') }}:</label>
                                <p>{{ $midStayReport->report->familiar_relation_and_evo ?: 'No hay datos disponibles' }}
                                </p>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            @if (Auth::user()->speciality === 'admin')
                                <form action="{{ route('mid_stay_reports.update', $midStayReport) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label
                                            for="program_duration_forecast">{{ __('reports.program_duration_forecast') }}:</label>
                                        <input class="form-control" id="program_duration_forecast"
                                            name="program_duration_forecast">{{ old('program_duration_forecast', $midStayReport->program_duration_forecast) }}
