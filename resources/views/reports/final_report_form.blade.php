...
@section('content')
    <div class="container-fluid pt-3">
        <div class="pdf-options ml-auto">
            <a class="btn" target="_blank" href="{{ route('reports.finalReport_preview', $finalReport) }}">{{ __('crud.preview') }}</a>
                        ...
                        <div class="card-body">
                            ...
                            @if (Auth::user()->speciality === 'admin')
                                <form action="{{ route('final_reports.update', $finalReport->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="request_number" name="request_number">{{ old('request_number', $finalReport->report->request_number) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="exit_reason" name="discharge_fundamentals">{{ old('discharge_fundamentals', $finalReport->discharge_fundamentals) }}</textarea>
                                        @error('exit_reason')
                                            <span class="span-error" role="alert">
                                                <span>{{ __('form.' . $message) }}</span>
                                            </span>
                            ...
                            @else
                                <div>
                                    ...
                                    <label class="label-title"
                                        for="discharge_fundamentals">{{ __('reports.exit_reason') }}:</label>
                                    <p>{{ $finalReport->discharge_fundamentals ?: 'No hay datos disponibles' }}</p>
                                    <label class="label-title"
                                        for="request_number">{{ __('reports.request_number') }}:</label>
                            ...
                            @if (Auth::user()->speciality === 'admin' || Auth::user()->speciality === 'worker')
                                <form action="{{ route('final_reports.update', $finalReport->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="social_familiar_situation" name="social_familiar_situation">{{ old('social_familiar_situation', $finalReport->report->social_familiar_situation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="professional_situation" name="laboral_educative_economical_situation">{{ old('laboral_educative_economical_situation', $finalReport->report->laboral_educative_economical_situation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="jury_situation" name="judicial_situation">{{ old('judicial_situation', $finalReport->report->judicial_situation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="evo_and_objectives" name="social_evo_and_objectives">{{ old('social_evo_and_objectives', $finalReport->report->social_evo_and_objectives) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="social_diagnosis" name="social_diagnosis">{{ old('social_diagnosis', $finalReport->report->social_diagnosis) }}</textarea>
                    ...
                    <div id="collapse-health-area" class="collapse hide">
                        <div class="card-body">
                            @if (Auth::user()->speciality === 'admin' || Auth::user()->speciality === 'medical')
                                <form action="{{ route('final_reports.update', $finalReport->report->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group">
                                        <label for="toxic_summary">{{ __('reports.toxic_summary') }}:</label>
                                        <textarea class="form-control" id="toxic_summary" name="about_toxicology">{{ old('about_toxicology', $finalReport->report->about_toxicology) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="health_situation_at_entry" name="health_at_entry">{{ old('health_at_entry', $finalReport->report->health_at_entry) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="phisical_health_evo" name="physical_health_condition">{{ old('physical_health_condition', $finalReport->report->physical_health_condition) }}</textarea>
                                        @error('health_at_entry')
                                            <span class="span-error" role="alert">
                                                <span>{{ __('form.' . $message) }}</span>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="toxic_control_and_analysis" name="toxicological_controls">{{ old('toxicological_controls', $finalReport->report->toxicological_controls) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="analytics" name="other_medical_attention">{{ old('other_medical_attention', $finalReport->other_medical_attention) }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label
                                            for="diagnosis_third_axis">{{ __('reports.diagnosis_third_axis') }}:</label>
                                        <textarea class="form-control" id="diagnosis_third_axis" name="health_diagnosis">{{ old('health_diagnosis', $finalReport->report->health_diagnosis) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="treatment_at_discharge" name="health_situation_at_discharge">{{ old('health_situation_at_discharge', $finalReport->health_situation_at_discharge) }}</textarea>
                            ...
                            @else
                                <div>
                                    ...
                                    <p>{{ $finalReport->report->other_health_atentions ?: __('reports.no_available_data') }}
                                    </p>
                        ...
                        <div class="card-body">
                            @if (Auth::user()->speciality === 'admin' || Auth::user()->speciality === 'psychologist')
                                <form action="{{ route('final_reports.update', $finalReport->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="start_valoration" name="psycho_entry_valoration">{{ old('psycho_entry_valoration', $finalReport->report->psycho_entry_valoration) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="psycho_valoration" name="psycho_evaluation_with_instruments">{{ old('psycho_evaluation_with_instruments', $finalReport->report->psycho_evaluation_with_instruments) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="diagnosis_first_and_second_axis" name="psycho_diagnosis">{{ old('psycho_diagnosis', $finalReport->report->psycho_diagnosis) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="psycho_intervention_objectives" name="psycho_interventions">{{ old('psycho_interventions', $finalReport->report->psycho_interventions) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="motivation" name="about_motivation">{{ old('about_motivation', $finalReport->report->about_motivation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="situation_at_discharge" name="psycho_situation_at_discharge">{{ old('psycho_situation_at_discharge', $finalReport->psycho_situation_at_discharge) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="pyscho_outgoings_value" name="psycho_outgoings_value">{{ old('psycho_outgoings_value', $finalReport->psycho_outgoings_value) }}</textarea>
                            ...
                            @else
                                <div>
                                    ...
                                    <p>{{ $finalReport->report->psycho_evaluation_with_instruments ?: __('reports.no_available_data') }}
                                    </p>
                                    <label class="label-title"
                                        for="diagnosis_first_and_second_axis">{{ __('reports.diagnosis_first_and_second_axis') }}:</label>
                                    ...
                                    <label class="label-title"
                                        for="situation_at_discharge">{{ __('reports.situation_at_discharge') }}:</label>
                                    <p>{{ $finalReport->report->psycho_situation_at_discharge ?: __('reports.no_available_data') }}
                                    </p>
                                    <label class="label-title"
                                    ...
                                    <label class="label-title"
                                        for="pyscho_outgoings_value">{{ __('reports.pyscho_outgoings_value') }}:</label>
                                    <p>{{ $finalReport->report->pyscho_outgoings_value ?: __('reports.no_available_data') }}
                                    </p>
                            ...
                            @if (Auth::user()->speciality === 'admin' || Auth::user()->speciality === 'educator')
                                <form action="{{ route('final_reports.update', $finalReport->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="at_habits" name="habit_adaptation">{{ old('habit_adaptation', $finalReport->report->habit_adaptation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="at_activities" name="activities_adaptation">{{ old('activities_adaptation', $finalReport->report->activities_adaptation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="at_regulations" name="normativity_adaptation">{{ old('normativity_adaptation', $finalReport->report->normativity_adaptation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="at_workouts_or_formation" name="workout_adaptation">{{ old('workout_adaptation', $finalReport->report->workout_adaptation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="at_leisure_and_free_time" name="leisure_adaptation">{{ old('leisure_adaptation', $finalReport->report->leisure_adaptation) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="mates_relation" name="partners_relationship">{{ old('partners_relationship', $finalReport->report->partners_relationship) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="employees_relation" name="therapeutic_crew_relationship">{{ old('therapeutic_crew_relationship', $finalReport->report->therapeutic_crew_relationship) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="educative_outgoings_value" name="educative_outgoings_value">{{ old('educative_outgoings_value', $finalReport->report->educative_outgoings_value) }}</textarea>
                            ...
                            @if (Auth::user()->speciality === 'admin'|| Auth::user()->speciality === 'worker')
                                <form action="{{ route('final_reports.update', $finalReport->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="reference_familiars_and_impication_degree" name="reference_familiars">{{ old('reference_familiars', $finalReport->report->reference_familiars) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="familiar_relation_and_evo" name="familiar_evo_and_realtionship">{{ old('familiar_evo_and_realtionship', $finalReport->report->familiar_evo_and_realtionship) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        <label
                                            for="familiar_situation_at_discharge">{{ __('reports.familiar_situation_at_discharge') }}:</label>
                                        <textarea class="form-control" id="familiar_situation_at_discharge" name="familiar_situation_at_discharge">{{ old('familiar_situation_at_discharge', $finalReport->familiar_situation_at_discharge) }}</textarea>
                                        @error('familiar_evo_and_realtionship')
                                            <span class="span-error" role="alert">
                                                <span>{{ __('form.' . $message) }}</span>
                                            </span>
                            ...
                            @if (Auth::user()->speciality === 'admin')
                                <form action="{{ route('final_reports.update', $finalReport->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="rationale_for_departure" name="discharge_fundamentals">{{ old('discharge_fundamentals', $finalReport->discharge_fundamentals) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="intervention_objectives_after_the_end" name="after_discharge_objectives">{{ old('after_discharge_objectives', $finalReport->after_discharge_objectives) }}</textarea>
