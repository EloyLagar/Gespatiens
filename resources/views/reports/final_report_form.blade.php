                ...
                <div id="collapse-social-area" class="collapse hide">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <p>{{ $finalReport->report->judicial_situation ?: __('reports.no_available_data') }}</p>

                            <label class="label-title" for="evo_and_objectives">{{ __('reports.evo_and_objectives')
                                }}:</label>
                            <p>{{ $finalReport->report->evo_and_objectives ?: __('reports.no_available_data') }}</p>
                ...
                <div id="collapse-health-area" class="collapse hide">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <p>{{ $finalReport->health_situation_at_discharge ?:
                ...
                <div id="collapse-psycho-area" class="collapse hide">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <label class="label-title"
                                for="psycho_intervention_objectives">{{__('reports.psycho_intervention_objectives')}}:</label>
                            <p>{{ $finalReport->report->psycho_interventions ?: __('reports.no_available_data') }}</p>
                            ...
                            <p>{{ $finalReport->report->pyscho_outgoings_value ?: __('reports.no_available_data') }}</p>
                ...
                <div id="collapse-educative-area" class="collapse hide">
                    <div class="card-body">
                        ...
                        <form action="{{ route('final_reports.update', $finalReport->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="educative_outgoings_value"
                                    name="educative_outgoings_value">{{ old('educative_outgoings_value', $finalReport->report->educative_outgoings_value) }}</textarea>
                        ...
                        <div>
                            ...
                            <p>{{ $finalReport->report->activities_adaptation ?: __('reports.no_available_data') }}</p>

                            <label class="label-title" for="at_regulations">{{__('reports.at_regulations')}}:</label>
                            <p>{{ $finalReport->report->normativity_adaptation ?: __('reports.no_available_data') }}</p>

                            <label class="label-title"
                                for="at_workouts_or_formation">{{__('reports.at_workouts_or_formation')}}:</label>
                            <p>{{ $finalReport->report->workout_adaptation ?: __('reports.no_available_data') }}</p>

                            <label class="label-title"
                                for="at_leisure_and_free_time">{{__('reports.at_leisure_and_free_time')}}:</label>
                            <p>{{ $finalReport->report->partners_relationship ?: __('reports.no_available_data') }}</p>
                ...
                <div id="collapse-follow-up-area" class="collapse hide">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <p>{{ $finalReport->report->discharge_fundamentals ?: 'No hay datos disponibles' }}</p>
                            <label class="label-title"
                                for="after_discharge_objectives">{{__('reports.after_discharge_objectives')}}:</label>
                            <p>{{ $finalReport->report->after_discharge_objectives ?: 'No hay datos disponibles' }}</p>
                        </div>
                        @endif
                    </div>
                </div>
