...
@section('content')
    <div class="container-fluid pt-3">
        ...
        <div class="action-buttons">
            <a href="{{ route('patients.edit', $finalReport->report->patient) }}" class="goBackBtn btn"><i
                    class='bx bx-left-arrow-alt'></i></a>
        </div>
        <h1 class="text-center mb-3">{{ __('reports.final_report') }}</h1>
                            ...
                            @if (Auth::user()->speciality === 'admin')
                                <form action="{{ route('final_reports.update', $finalReport) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="request_number" name="request_number"
                                            value="{{ old('request_number', $finalReport->report->request_number) }}">
                        ...
                        <div class="card-body">
                            @if (Auth::user()->speciality === 'admin' || Auth::user()->speciality === 'psychologist')
                                <form action="{{ route('final_reports.update', $finalReport) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label
                                            for="pyscho_outgoings_value">{{ __('reports.develop_and_therapeutic_outgoings_valoration') }}:</label>
                        ...
                        <div class="card-body">
                            @if (Auth::user()->speciality === 'admin' || Auth::user()->speciality === 'educator')
                                <form action="{{ route('final_reports.update', $finalReport) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label
                                            for="educative_outgoings_value">{{ __('reports.develop_and_therapeutic_outgoings_valoration') }}:</label>
                                        <textarea class="form-control" id="educative_outgoings_value" name="educative_outgoings_value">{{ old('educative_outgoings_value', $finalReport->educative_outgoings_value) }}</textarea>
