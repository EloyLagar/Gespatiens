            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="model-info">
                        <p><span class="heavy-span">{{ __('patients.full_name') }}</span>: <span class="info-span">{{ $patient->full_name }}</span></p>
                        <p><span class="heavy-span">{{ __('patients.dni') }}</span>: <span class="info-span">{{ $patient->dni }}</span></p>
                        <p><span class="heavy-span">{{ __('patients.visit_code') }}</span>: <span class="info-span">{{ $patient->visit_code }}</span></p>
                        <p><span class="heavy-span">{{ __('patients.birth_date') }}</span>: <span class="info-span">{{ $patient->birth_date }}</span></p>
                        <p><span class="heavy-span">{{ __('patients.address') }}</span>: <span class="info-span">{{ $patient->address }}</span></p>
                        <p><span class="heavy-span">{{ __('patients.belongings') }}</span>: <span class="info-span">{{ $patient->belongings }}</span></p>
                        <p><span class="heavy-span">{{ __('patients.phone_number') }}</span>: <span class="info-span">{{ $patient->phone_number }}</span></p>
                        <p><span class="heavy-span">{{ __('patients.extra_info') }}</span>: <span class="info-span">{{ $patient->extra_info }}</span></p>
                        <p><span class="heavy-span">{{ __('patients.abuse_substances') }}</span>: <span class="info-span">{{ $patient->abuse_substances }}</span></p>
                        <p><span class="heavy-span">{{ __('patients.exit_date') }}</span>: <span class="info-span">{{ $patient->exit_date }}</span></p>
                        <p><span class="heavy-span">{{ __('patients.entry_date') }}</span>: <span class="info-span">{{ $patient->entry_date }}</span></p>
