...
<div class="wrapper d-flex flex-column">
    <div class="d-flex col-12 d-flex flex-column flex-md-row align-items-center">
        ...
        <div class="float-right d-flex flex-md-row ml-auto mt-2 mb-1 col-sm-12 col-md-6 col-lg-4">
            ...
            <a href="{{ route('reports.final_report_form', $patient) }}" class="btn col-md-6 mr-2 col-lg-6">{{
                __('reports.final') }}</a>
            <a href="{{ route('reports.mid_stay_report_form', $patient) }}" class="btn col-md-6 col-lg-6">{{
                __('reports.mid_stay') }}</a>
        </div>
    </div>
            ...
            <div class="col-md-4 order-md-1">
                <div class="card">
                    <div class="card-header  d-flex align-items-center">
                        ...
                        @if ($patient->number != null)
                        <a class="btn suscribe-btn  ml-auto float-right d-flex align-items-center"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="tutor_educator" id="tutor_educator">
                                        <option value="" disabled selected>{{ __('crud.select_a') }}
                                            {{ __('user.speciality.educator') }}</option>
                                        @forelse ($educators as $educator)
                                        <option value="{{ $educator->id }}" {{ $patient->
                                            is_tutored->contains($educator->id) ? 'selected' : '' }}>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control " name="tutor_psycho" id="tutor_psycho">
                                        ...
                                        <option value="{{ $psychologist->id }}" {{ $patient->
                                            is_tutored->contains($psychologist->id) ? 'selected' : '' }}>
                                            {{ $psychologist->name }}
                                        </option>
                                        @empty
                                        @endforelse
